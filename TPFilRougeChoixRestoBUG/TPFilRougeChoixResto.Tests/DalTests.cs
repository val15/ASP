...
namespace TPFilRougeChoixResto.Tests
{
    ...
    public class DalTests
    {
        ...
        public void CreerRestaurant_AvecUnNouveauRestaurant_ObtientTousLesRestaurantsRenvoitBienLeRestaurant()
        {
                ...
                Assert.AreEqual("0330257032", restos[0].Telephone);
       ...
       // [TestMethod]
        ...
        //    dal.ModifierRestaurant(id, "La bonne cuillère", "0330257032", "tettse@TestCategoryAttribute.mg");
        ...
        public void ADejaVote_UtilisateurNAPasVote_RetourneFalse()
        {
            ...
            bool pasVote = dal.ADejaVote(idSondage, idUtilisateur);
        ...
        [TestCleanup] //la médode qui suis cette décoration est appellée apres chaque teste
